  ...
  await knex('projects').insert([
      {
          ...
          clients_id: "6FF4A3AE-2135-46DB-9238-D1E90E8B0719", // Ensure this matches a client ID
      ...
      },
      {
          ...
          clients_id: "1E405F81-A7C8-4148-8704-5B29F97285E9", // Ensure this matches a client ID
  ...
  await knex('tasks').insert([
      {
          ...
          projects_id: "77946ca1-73a1-4af1-a38f-af2bef758e74", // Ensure this matches a project ID
          category: "Branding",
          status: "active",
          quantity: 1,
          description: "The best task you've ever seen",
          task_name: "Brand pack"
      },
      {
         id: "8CE85981-87BF-4318-A43D-E4C68A36C91B",
         projects_id: "1aed3a28-d849-4073-8845-e8731b4170ab", // Ensure this matches a project ID
